...
StyledRect {
    ...
    property string currentPage: "keybindings"
    ...
    readonly property list<var> pages: [
        {
            id: "keybindings",
            name: qsTr("Keybindings"),
            icon: "keyboard_alt",
            component: keybindingsComponent
        },
        {
            id: "window-rules",
            name: qsTr("Window Rules"),
            icon: "select_window",
            component: windowRulesComponent
        },
    ]
    ...
    Component {
        id: keybindingsComponent
        Keybindings {}
    }

    Component {
        id: windowRulesComponent
        WindowRules {}
    }
}
